...
import numpy as np
import os
def get_error(state, testing_data):
    enabled = []
    ...
    return adder(input_port_assignments, lut_string_inst, Lut_INIT_List, bit_width, arg1, arg2, enabled, testing_data)
...
#     print(get_error(input_state, testing_data))
