...
class ReplayBuffer():
    def __init__(self, max_size, input_dims):
        ...
        self.new_state_memory = np.zeros((self.mem_size, *input_dims), dtyp=np.float32)
...
class Agent():
    ...
    def learn(self):
        ...
        self.epsilon = self.epsilon - self.esp_dec if self.espilon > self.eps_min else self.eps_min
